...
def sample(args, device, generative_model, dataset_info,
           ...
           fix_noise=False,timestep = 1000,scheduler="DDPM"):
    ...
    if args.probabilistic_model == 'diffusion':
        if scheduler == "DDPM":
            ...
            x, h = generative_model.sample_ddim(batch_size, max_n_nodes, node_mask, edge_mask, context, fix_noise=fix_noise,timestep=timestep)
